...
if __name__ == '__main__':
    ...
    credential_path = '/Users/administrator/Documents/Giang/PythonProgramming/GoogleAssistant/credentials.json'
    device_model_id = 'fluent-flame-pepper'
    device_id = 'new-pepper01'
    lang = 'en-US'
    verbose = False
    grpc_deadline = DEFAULT_GRPC_DEADLINE

    main(api_endpoint, credential_path, device_model_id, device_id, lang, verbose, grpc_deadline)
